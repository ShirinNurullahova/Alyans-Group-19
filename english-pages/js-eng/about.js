...
tl.from('.menu-li', {opacity:0, y: '-200px', duration:0.4, stagger:0.1},'-=0.4')
...
mtl.from(".animation-subheader", {opacity:0, duration:1.3,xPercent: -100} )
mtl.from(".animation-header", {opacity:0, duration:0.8, xPercent: -100} )
mtl.from(".animation-description", {opacity:0, duration:0.7,xPercent: -100} )
mtl.from(".animation-links", {opacity:0, duration:0.3, ease:"power0", xPercent: -100} )
mtl.from(".animation-description-news", {opacity:0, duration:0.6,xPercent: -100} )

var ytl = gsap.timeline();
ytl.from(".service-image-container", {opacity:0, duration:1.6,xPercent: 100, yPercent: 60} )

var atl = gsap.timeline();
atl.from(".about-image-container", {opacity:0, duration:1.6,xPercent: 100, yPercent: 60} )

var ftl = gsap.timeline();
ftl.from(".form-container", {opacity:0, duration:1.7,yPercent: 100} )

var vtl = gsap.timeline();
vtl.from(".text-container-news", {opacity:-1, duration:3.5, yPercent: -300} )
